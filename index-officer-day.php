			...
			<div class="row email-form">
				...
				<div class="col-sm-4">
					<form>
						...
						<div class="form-group">
							<label for="password2">GST ID/Authorisation Key</label>
							<input type="password" class="form-control" id="password2" name="password2" placeholder="GST ID/Authorisation Key" required>
						</div>
